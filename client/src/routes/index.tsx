    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 lg:grid-cols-2 lg:px-8 lg:py-28">
            <div>
              ...
              <p className="mt-6 max-w-lg text-lg text-muted-foreground">
                Upload lecture notes, papers, or textbooks. Lumen instantly generates summaries,
                flashcards, and quizzes so you learn faster and remember longer.
              </p>
        ...
        <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          ...
          <div className="mt-14 grid gap-6 md:grid-cols-3">
            {[
              ...
              >
                <span
                  className="inline-flex h-11 w-11 items-center justify-center rounded-xl text-primary-foreground shadow-glow"
                  style={{ background: "var(--gradient-primary)" }}
                >
        ...
        <section className="mx-auto max-w-7xl px-4 pb-24 sm:px-6 lg:px-8">
          <div
            className="relative overflow-hidden rounded-3xl px-8 py-16 text-center text-primary-foreground shadow-glow"
            style={{ background: "var(--gradient-hero)" }}
          >
            ...
            <p className="mx-auto mt-3 max-w-xl text-base opacity-90">
              Sign up free and upload your first PDF in under a minute.
            </p>
